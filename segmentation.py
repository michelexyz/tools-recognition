...
from useful import remove_imperfections, resize_to_fixed_d

from parameters import *


def segment_and_detect(image, obj_thresh, m, descriptor, f_extraction_data = None, apply_on_mask = True, show_objects= False, ):
    ...
    for i in range(0, numLabels):
        ...
        if i == 0:
            ...
            if area > 350:
                ...
                if apply_on_mask:
                    description = descriptor.describe(componentMask, componentMaskBool.astype("bool"), area, name = obj_name)
                else:
                    description = descriptor.describe(masked, componentMaskBool.astype("bool"), area, name = obj_name)
